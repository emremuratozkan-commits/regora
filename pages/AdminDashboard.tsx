...
const AdminDashboard: React.FC = () => {
  const { openModal, addSite, updateSite, sites, removeSite, switchSite, property, activities, globalStats, tickets, forumPosts, pendingUsers } = useApp();
  ...
  return (
    <div className="space-y-6 animate-fade-in pb-24">
      ...
      <div className="px-2 space-y-4">
        ...
        <div className="bg-dark-card p-3 rounded-2xl border border-dark-border flex items-center gap-3">
            ...
            <div className="flex-1">
                ...
                <div className="relative">
                    <select 
                        ...
                        className="w-full bg-transparent text-white font-bold text-sm appearance-none outline-none cursor-pointer"
                    >
                        {sites.map(site => (
      ...
      <div className="grid grid-cols-2 gap-4">
          ...
          <Card gradient className="col-span-2 border-gold-500/20 shadow-lg shadow-gold-500/5">
              <div className="flex justify-between items-start mb-4">
                  <div>
                      <p className="text-gray-400 text-xs font-bold uppercase tracking-widest mb-1">{property.name} Varlıkları</p>
